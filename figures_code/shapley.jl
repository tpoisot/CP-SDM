...
hist!(ax2, mask(S[smimp], nodata(unsure, false)), color=(:grey70, 0.7), bins=bins, normalization=:pdf)
hist!(ax2, mask(S[smimp], nodata(sure_presence, false)), color=(:forestgreen, 0.7), bins=bins, normalization=:pdf)
tightlimits!(ax2)
