...
The model was trained, validated, and applied on the 19 WorldClim2 BIOCLIM variables #cite(<fick2017worldclim>), at a spatial resolution of 2.5 minutes of arc. Preliminary analyses using 0.5, 2.5, 5, and 10 minutes of arc show that the qualitative results presented hold. For the projection of the model under climate change, I only report the future data under the SSP245 scenario ("middle of the road"), for #change[six GCMS: MRI_ESM2_0, ACCESS_CM2, EC_Earth3_Veg, CanESM5, GFDL_ESM4, and MIROC6. The climatic data were retrieved for the 2081-2100 period]. #add[The prediction for a score under future climates is measured as the median of the predicted values for each of the GCMs, and the prediction of whether this point in within the future range of the species is done by applying majority voting to the six predictions.]
...
#add[Still relevant that there is an association as these measure different sources of uncertainty. Phrase as a suggestion to collect more data vs. collect more validation data.]
