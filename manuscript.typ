...
#add[TK something about variability only, not using the ensemble average]
...
#add[TK Still relevant that there is an association as these measure different sources of uncertainty. Phrase as a suggestion to collect more data vs. collect more validation data.]
